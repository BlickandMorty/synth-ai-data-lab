...
export default function DatasetsPage() {
  ...
  return <div className="space-y-6 animate-in fade-in duration-500">
    ...
    <div className="flex flex-wrap gap-2"><a href="/api/export?format=packets"><Button variant="outline" size="sm">Export all packets JSONL</Button></a><a href="/api/export?format=preferences"><Button variant="outline" size="sm">Export eligible preference pairs JSONL</Button></a><a href="/api/export?format=manifest"><Button variant="outline" size="sm">Export dataset manifest</Button></a><Button variant="ghost" size="sm" onClick={load}>Refresh counts</Button></div>
  </div>;
}
